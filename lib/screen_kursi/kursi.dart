...
class Kursis extends StatefulWidget {
  const Kursis({Key? key});

  @override
  _KursisState createState() => _KursisState();
}

class _KursisState extends State<Kursis> {
  final String url = 'http://192.168.43.116:8080/api/kursis';

  Future<List<dynamic>> getKursis() async {
                              ...
                              children: [
                                ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    final kursi = snapshot.data![index];
                                    return Padding(
